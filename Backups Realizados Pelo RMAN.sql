...
V$RMAN_BACKUP_JOB_DETAILS.TIME_TAKEN_DISPLAY as Duracao,
V$INSTANCE.INSTANCE_NAME as Instancia,
V$INSTANCE.HOST_NAME as hostname,
...
where V$RMAN_BACKUP_JOB_DETAILS.INPUT_TYPE='DB FULL'
